...
```json
{
  "gateway": {
    ...
    "auth": {
      "mode": "token",
      "token": "4267bd714b23adeba00e1e99ad60c066f29006cc5e84a15e"
    }
  }
}
```
...
| **Authorization** | `Bearer 4267bd714b23adeba00e1e99ad60c066f29006cc5e84a15e` |
...
| Token | 4267bd714b23adeba00e1e99ad60c066f29006cc5e84a15e | 必須與 n8n Header 同步 |
...
curl -s "http://localhost:18789/v1/responses" \
  -X POST \
  -H "Authorization: Bearer 4267bd714b23adeba00e1e99ad60c066f29006cc5e84a15e" \
