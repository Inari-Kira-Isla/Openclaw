...
@GodKiraCheok_bot 你點睇？要開始邊部分？"""
    ...
    # 直接發送到 Telegram
    cmd = f'''curl -s -X POST "https://api.telegram.org/bot8328573670:AAHyDxm8885w9IhsOKlRN6cV3PGLFtEjOc8/sendMessage" -d "chat_id=-5138835175" -d "text={message}" -d "parse_mode=Markdown"'''
    os.system(cmd)
